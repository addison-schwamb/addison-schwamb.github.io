...
PhD Electrical Engineering (August 2025)

Cognitive, Computational, and Systems Neuroscience Pathway

&emsp; **Dissertation:** Large-Scale Modeling & Inference of Non-Stationary Brain Dynamics

&emsp; **Advisor:** ShiNung Ching
...
### Research Interests
---
Clinical neuroscience presents an especially compelling domain for the engineering of digital twins, i.e., computational models that can serve as *in silico* replicas of individuals' physiology. A particular prevailing challenge in this context is the assimilation of physiological data spanning multiple spatial and temporal scales. The overall goal of my envisioned research program is to enable the development of digital twins that embed formal, transparent physiological dynamics through advances in statistical signal processing, estimation, and control.

### Publications
---
#### Journals
* **A. Schwamb**, Z. Yu, and S. Ching, "Blind identification of state transitions and latent neural dynamics from electrophysiological recordings," *Journal of Neuroscience Methods*, vol. 425, 2025.
* **A. Schwamb**, Z. Yu, and S. Ching, "Identification of modulated whole-brain dynamical models from nonstationary electrophysiological data," *Journal of Neural Engineering*, 2025.

#### Conference Proceedings
* **A. Schwamb**, M. Singh, R. Guerriero, and S. Ching, (2024) "Data-driven modeling of neural dynamics from EEG to track physiological changes," in IEEE Engineering in Medicine and Biology Conference (2024)
* Z. Xiong, **A. Schwamb**, B. Palanca, and S. Ching, "Estimating and detecting slow wave events in EEG," in IEEE Engineering in Medicine and Biology Conference (2024)
...
---
#### Oral Presentations
* **A. Schwamb** and S. Ching, "Identifying latent neuromodulatory brain states within individualized cortical dynamics," Society for Neuroscience, October 5-9, 2024, Chicago, IL.
...
Fall 2026:
* Introduction to Computer Organization (COMP231)
* Data Mining (COMP345)

Spring 2026:
* Introduction to Computer Science (COMP141)
* Introduction to Computer Organization (COMP231)
* Data Structures & Algorithms (COMP241)
...
---
**Internal Service**
Women in Computer Science Faculty Mentor (25-26)

**External Service**
Reviewer:
* ACM Special Interest Group on Computer Science Education (2026)
* IEEE Conference on Control Technology and Applications (2025)
